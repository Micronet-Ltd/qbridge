================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TestQBTreqVM Project Overview
===============================================================================

The application wizard has created this TestQBTreqVM application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your TestQBTreqVM application.
...
TestQBTreqVM.h
    ...
    project specific headers and declares the CTestQBTreqVMApp application class.

TestQBTreqVM.cpp
    This is the main application source file that contains the application
    class CTestQBTreqVMApp.
...
TestQBTreqVMDlg.h, TestQBTreqVMDlg.cpp - the dialog
    These files contain your CTestQBTreqVMDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named TestQBTreqVM.pch and a precompiled types file named StdAfx.obj.
