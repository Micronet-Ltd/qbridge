================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TestAppMFCTreq Project Overview
===============================================================================

The application wizard has created this TestAppMFCTreq application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your TestAppMFCTreq application.

TestAppMFCTreq.vcproj
...
TestAppMFCTreq.h
    ...
    project specific headers and declares the CTestAppMFCTreqApp application class.

TestAppMFCTreq.cpp
    This is the main application source file that contains the application
    class CTestAppMFCTreqApp.
...
TestAppMFCTreqDlg.h, TestAppMFCTreqDlg.cpp - the dialog
    These files contain your CTestAppMFCTreqDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named TestAppMFCTreq.pch and a precompiled types file named StdAfx.obj.
